...
object RandomForestRegressionModel {
  def main(args: Array[String]) {
    ...
    //val outPmmlFile="/home/hdfs/pmml/spark2pmml_regression_RandomForest.pmml"
    ...
    val regression = new RandomForestRegressor().setLabelCol(formula.getLabelCol).setFeaturesCol(formula.getFeaturesCol)
