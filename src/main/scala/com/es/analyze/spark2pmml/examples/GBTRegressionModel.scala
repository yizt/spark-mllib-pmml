...
object GBTRegressionModel {
  def main(args: Array[String]) {
    ...
    //val outPmmlFile="/home/hdfs/pmml/spark2pmml_regression_GBT.pmml"

    val spark = SparkSession.builder.
      master(args(0)).
      appName("GBTRegressionModel").
      getOrCreate()
    ...
    val regression = new GBTRegressor().setLabelCol(formula.getLabelCol).setFeaturesCol(formula.getFeaturesCol)
