...
object GradientBoostedTreeClassifier {
  def main(args: Array[String]): Unit = {
    ...
    //JAXBUtil.marshalPMML(pmml, new StreamResult(new FileOutputStream(args(2))))
    JAXBUtil.marshalPMML(pmml, new StreamResult(new FileOutputStream("out/spark2pmml_gbt.pmml")))
    // Make predictions.
