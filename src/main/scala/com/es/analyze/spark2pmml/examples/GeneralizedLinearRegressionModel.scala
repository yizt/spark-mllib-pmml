...
object GeneralizedLinearRegressionModel {
  def main(args: Array[String]) {
    ...
    //val outPmmlFile="/home/hdfs/pmml/spark2pmml_regression_GeneralizedLinear.pmml"
    ...
    val regression = new GeneralizedLinearRegression().setFamily("gaussian").setLink("identity").setMaxIter(10).setRegParam(0.3)
    //.setLabelCol(formula.getLabelCol). setFeaturesCol(formula.getFeaturesCol)
